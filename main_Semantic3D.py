...
class Semantic3D:
    def __init__(self):
        # self.name = 'Semantic3D' #Thesis project
        self.name = 'Semantic3D'
        # self.path = '/data/semantic3d' #Thesis project
        self.path = '/workspace/Storage_fast/point_cloud_data/data_randLA-Net'
        ...
        #                        8: 'cars'} #Thesis project
        self.label_to_names = {0: 'not_resected_volume',
                               1: 'resected_volume',}
        self.num_classes = len(self.label_to_names)
        self.label_values = np.sort([k for k, v in self.label_to_names.items()])
        self.label_to_idx = {l: i for i, l in enumerate(self.label_values)}
        self.ignored_labels = np.sort([]) # Thesis project: background, 0-class, removed from list
        ...
        validation_arr = [2,4,16,46,70,23] #Joy: choose my validation
        self.all_splits = [str(num) for num in validation_arr]
        self.val_split = 1
        ...
        for i, file_path in enumerate(self.train_files):
            #if self.all_splits[i] == self.val_split: Joy: select my validation set
            if any(num in file_path for num in self.all_splits):
        ...
        """self.ascii_files = {
            ID15_without_class.ply': 'ID15_without_class.labels',
            'Lizard_ID7_without_class.ply': 'Lizard_ID7_without_class.labels',
            'Lizard_ID5_without_class.ply': 'Lizard_ID5_without_class.labels'}"""
        self.ascii_files = {
            'STL_Lizard_ID001.ply': 'STL_Lizard_ID001.labels',
            'STL_Lizard_ID008.ply': 'STL_Lizard_ID008.labels',
            'STL_Lizard_ID013.ply': 'STL_Lizard_ID013.labels',
            'STL_Lizard_ID017.ply': 'STL_Lizard_ID017.labels',
            'STL_Lizard_ID025.ply': 'STL_Lizard_ID025.labels',
            'STL_Lizard_ID036.ply': 'STL_Lizard_ID036.labels'}
